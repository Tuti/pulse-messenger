...
export default function ChatMessages() {
  ...
  const testMessages = [
    ...
    {
      displayName: 'tuti',
      message: 'this is a test message this is a test message this is a test message this is a test message this is a test message this is a test message this is a test message ',
      timestamp: '7:00am'
    },
    {
      displayName: 'user1',
